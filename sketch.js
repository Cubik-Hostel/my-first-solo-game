...
var topGround
var bob, bobImg
var obstacleTop, obs3, obs2
var obstacleBottom, obs1, obsBottom2, obsBottom3
...
bobImg = loadAnimation("assets/bob1.png","assets/bob2.png")
...
//creating balloon     
bob = createSprite(100,200,20,50);
...
if(topObstaclesGroup.isTouching(bob) || bob.isTouching(topGround)
|| bob.isTouching(bottomGround) || bottomObstaclesGroup.isTouching(bob)){
...
switch(rand) {
  case 1: obstacleTop.addImage(obs3);
          break;
...
function spawnObstaclesBottom() 
{
    ...
    obsBottom2.scale = 0.2;
    

   //generate random bottom obstacles
    var rand = Math.round(random(1,3));
    switch(rand) {
      case 1: obstacleBottom.addImage(obs1);
              break;
